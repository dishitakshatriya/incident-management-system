...
class UpdateTicketDetails extends Component {
    ...
    handleSubmit = event => {
        ...
        console.log(data); 
        axios.put('/api/ticket/updateTicket/'+data.id,data,config)
        .then(res => {
                console.log(res);
        ...
        return(
            ...
            <h1>Update ticket</h1>
                ...
                <Form.Group controlId="formGridSolution">
                    ...
                    <Form.Control name='solution' onChange={this.handleInputChange}/>
                </Form.Group>
...
export default withRouter(UpdateTicketDetails);