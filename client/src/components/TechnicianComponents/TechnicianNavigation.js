...
class TechnicianNavigation extends React.Component {
    ...
    return (
      <>
        <Navbar bg="light" variant="light">
          <Navbar.Brand href="#home">Incident Management System for Technician</Navbar.Brand>
          <Nav className="mr-auto">
            {/* <Nav.Link href="/technician/new">Create a Technician</Nav.Link>
            <Nav.Link href="#pricing">Knowledge Base</Nav.Link>
...
export default withRouter (TechnicianNavigation);